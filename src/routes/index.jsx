...
const router = createBrowserRouter([
  {
        ...
        children: [
          ...
          { path: "signup", element: <PrivateAuthRedirectRoute> <Signup /> </PrivateAuthRedirectRoute>},
          { path: "login", element:<PrivateAuthRedirectRoute> <Login /> </PrivateAuthRedirectRoute> },
          { path: "email-to-reset-password", element: <EmailForgetPassword /> },
          { path: "teacher", element: (<PrivateRoute role={"teacher"}><TeacherBaseLayout /></PrivateRoute>),
            children: [
               ...
               { path: "show-all-students/student-details/:id", element: <StudentResultViewByTeacher /> },
              { path: "reset-password", element: <StudentResetPassword /> },

              ],
            },
          { path: "student", element: (<PrivateRoute role={"student"}><StudentBaseLayout /></PrivateRoute>),
             children: [
